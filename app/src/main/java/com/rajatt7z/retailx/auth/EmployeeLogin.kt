...
import com.rajatt7z.retailx.databinding.ActivityEmployeeLoginBinding
...
class EmployeeLogin : com.rajatt7z.retailx.utils.BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnLogin.setOnClickListener {
            ...
            viewModel.loginUser(email, password, "employee")
        }

        // Employee Registration is disabled - Admin adds employees
